...
public class Day11_8 {
	...
	public static void main(String[] args) 
	{
		...
		RatingCompare rc = new RatingCompare(); // rc is Comparator object 
		NamingCompare nc = new NamingCompare(); // nc is comparator object
		
		Collections.sort(al,rc);
		
		System.out.println("Sorted Data accoring to the rating");
		for(Movie m : al)
			System.out.println(m);
		...
		System.out.println("Sorted Data accoring to the names");
		for(Movie m : al)
			System.out.println(m);
